                ...
                <form action="/dashboard/transactions/add" method="post">
                    ...
                    <div class="field-group">
                        ...
                        <div class="field-container">
                            ...
                            <input id="destinationAddressStreet" name="destinationAddressStreet" value="" class=""
                                   required>
                        </div>
                        <!-- /.field-container -->
                        <div class="field-container">
                        ...
                        <div class="field-container">
                            ...
                            <input id="destinationAddressZipCode" name="destinationAddressZipCode" value="" class=""
                                   required>
                        </div>
                        <!-- /.field-container -->
                    </div>
