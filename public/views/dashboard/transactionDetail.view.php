                        ...
                        <div class="package-detail-content">
                            ...
                            <div class="col-dt-12 text-left clearfix">
                                <div class="package-detail-info clearfix">
                                    <p><strong><?= $transaction->package->status; ?> -
                                            $<?= money_format('%i', $transaction->cost); ?></strong></p>
                                    <div class="col-dt-6 col-mb-12">
                                        <p>Origin:</p>
                                        <?= $transaction->package->returnAddress->street; ?>,<br/>
                                        <?= $transaction->package->returnAddress->city; ?>
                                        , <?= $transaction->package->returnAddress->state; ?> <?= $transaction->package->returnAddress->zipCode; ?>
                                    </div>
                                    <!-- /.col-dt-12 -->
                                    <div class="col-dt-6 col-mb-12">
                                        <p>Destination:</p>
                                        <?= $transaction->package->destination->street; ?>,<br/>
                                        <?= $transaction->package->destination->city; ?>
                                        , <?= $transaction->package->destination->state; ?> <?= $transaction->package->destination->zipCode; ?>
                                    </div>
                                    <!-- /.col-dt-12 -->
                                </div>
                                <!-- /.package-detail-info -->
